            ...
            if (confirm_input == "yes"):
                ...
                if (len(links_to_download) > 0):
                    ...
                    for link in links_to_download:
                        ...
                        test_link = link # check if this link has already been entered
                        for duplicate_check_link in links_to_download:
                            print ("checking |",test_link,"| against |",duplicate_check_link,"|", sep="")
                            if (duplicate_check_link == test_link):
